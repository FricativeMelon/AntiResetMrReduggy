...
namespace AntiResetMrReduggy
{
    ...
    class ReduggyDialogueBox : DialogueBox
    {
        ...
        public ReduggyDialogueBox(string dialogue, string preface = "")
            : base(new Dialogue(preface+dialogue, Game1.getCharacterFromName("Mr. Reduggy", false)))
        {
        ...
        public override void receiveLeftClick(int x, int y, bool playSound = true)
        {
            ...
            {
                Game1.activeClickableMenu =  new ReduggyDialogueBox(oldDialogueString, "Seriously? You're not even listening, are you?"
        ...
        private void OnWarp(object sender, WarpedEventArgs e)
        {
            ...
            if (!visitedFarmToday && e.NewLocation is Farm)
            {
                ...
                if (model.runs > 1)
                {
                    ...
                    DialogueBox db = new ReduggyDialogueBox(GetReduggyString(model));
